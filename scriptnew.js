...
ptag.innerHTML="Once you search please Refresh the page because using promise";
...
image.setAttribute("src","https://images-eu.ssl-images-amazon.com/images/I/41o3sVUwXTL.jpg")
...
let thirukkural=new Promise((resolve,reject)=>{
    ...
    let request=new XMLHttpRequest();
        request.open(`GET`,`https://api-thirukkural.vercel.app/api?num=${txt.value}`)
        request.send();
...
resolve(data)
 ...
 thirukkural.then((res)=>{console.log(res)
 newDiv3B.innerHTML =
 `<p><b>குறள் எண்:${res.number}</p></b>
